...
## 📝 Conclusion (결론)
### EDA를 통해 관찰한 주요 사항
- (sky 결론) 비트코인은 경제 위기 동안 급격한 투자 수요 증가로 큰 변동성을 보이며 고수익 투기 자산으로 작용한 반면, 금은 안정적인 상승세를 유지하며 전통적 안전자산으로서의 역할을 강화했습니다. 두 자산은 경제적 불확실성 시기에 대체재로 간주되기도 하지만, 안정성과 변동성 측면에서 상반된 특성을 보여주고 있습니다.
